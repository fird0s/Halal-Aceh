...
<div class="container margin_60">
    <div class="row">
        <div class="col-md-10">
            <h1>Qiblah Direction locator/finder</h1>
            <p>Find the precise direction of Qibla using google maps. Gives a static compass as well as the ability to locate the prayer direction for Muslims using the landmarks.</p>

           <button type="button" class="btn btn-primary locate-me" style="text-align:center;">Get Qibla</button>

...
<!--[if gt IE 9]><!-->	<html> <!--<![endif]-->
  <head>
    ...
    <title>{{ $get_mosque->name }} | HalalAceh</title>
...
<![endif]-->
   ...
   <section class="parallax-window" data-parallax="scroll" data-image-src="{{{ asset('media/directory') }}}/{{ unserialize($get_mosque->images)[0] }}" data-natural-width="1400" data-natural-height="470">
    <div class="parallax-content-2">
        <div class="container">
            <div class="row">
                <div class="col-md-8 col-sm-8">
                    <h1>{{ $get_mosque->name }}</h1>
                    <span>{{ $get_mosque->location }}</span>

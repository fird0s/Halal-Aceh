...
<div  class="container margin_60">
		...
		<div class="box_style_cat">
			<ul id="cat_nav">
				<li><a href="#" id="active"><i class="icon_set_1_icon-93"></i><b>All Tours</b></a></li>
                ...
                <div class="strip_all_tour_list wow fadeIn" data-wow-delay="0.5s">
                   <div class="row">
                	<div class="col-lg-4 col-md-4 col-sm-4">
                    	<div class="img_list">
                            <a href="{{ route('get_tour_package', ['slug_url' => $data->slug_url]) }}">
                                <img src="{{{ asset('media/tour_package') }}}/{{ unserialize($data->images)[0] }}" alt="">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6">
                    		...
                    		<h3><strong>{{ $data->package_name }}</strong></h3>
                            <p>{{ strip_tags($data->description, 300) }}</p>
                             
                            </div>
                    </div>
					<div class="col-lg-2 col-md-2 col-sm-2">
                    	<div class="price_list"><div><sup>$</sup>{{ $data->price_per_person }}<span class="normal_price_list"></span><small>*Per person</small>
                        <p><a href="{{ route('get_tour_package', ['slug_url' => $data->slug_url]) }}" class="btn_1">Details</a></p>
                        </div>

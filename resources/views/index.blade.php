        ...
        <div class="container">
            <div class="row">
                <div class="col-md-3 col-sm-3 col-xs-3">
                    <div id="logo">
                        <a href="index.html"><img src="{{{ asset('/static/img/logo.png') }}}" width="160" height="34" alt="City tours" data-retina="true" class="logo_normal"></a>
...
<div class="container margin_60">
        ...
        <div class="main_title">
            <h2>Banda Aceh <span>Top</span> Destination</h2>

        ...
        <table class="table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>{{ $data->date_start }} <b>-</b> {{ $data->date_end }} </td>
              <td>{{ $data->contact_person }}</td>
              <td class="text-nowrap">
                <a href="{{ route('account_edit_event', ['id' => $data->id]) }}" class="btn btn-sm btn-icon btn-flat btn-default" data-toggle="tooltip" data-original-title="Edit">
                  <i class="icon wb-wrench" aria-hidden="true"></i>
                </a>
                <a href="{{ route('account_delete_event', ['id' => $data->id]) }}" class="btn btn-sm btn-icon btn-flat btn-default" data-toggle="tooltip" data-original-title="Delete">

    ...
    <div class="page-header page-header-bordered">
      <ol class="breadcrumb">
        ...
        <li><a href="javascript:void(0)">Account</a></li>
         <li><a href="{{ route('account_event') }}">Event</a></li>
    ...
    <div class="container-fluid">
       <form method="POST" action="" enctype="multipart/form-data">
              ...
              <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <div class="input-daterange input-group" id="datepicker">
                        <input type="text" class="input-sm form-control datepicker" data-date-format="yyyy/mm/dd" name="event_date_start" value="{{ $event->date_start }}">
                        <span class="input-group-addon">to</span>
                        <input type="text" class="input-sm form-control datepicker" data-date-format="yyyy/mm/dd" name="event_date_end" value="{{ $event->date_end }}">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="contact_person" value="{{ $event->contact_person }}">
                </div>
              ...
              <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <div class="input-daterange input-group">
                        <input type="text" class="input-sm form-control" name="time_start" value="{{ $event->time_start }}">
                        <span class="input-group-addon">to</span>
                        <input type="text" class="input-sm form-control" name="time_end" value="{{ $event->time_end }}">
                    </div>
                </div>
                <div class="form-group">
            ...
            <div class="form-group" style="padding: 15px;">
                ...
                <textarea class="form-control" rows="5" name="about">{{ $event->about }}</textarea>
            </div>

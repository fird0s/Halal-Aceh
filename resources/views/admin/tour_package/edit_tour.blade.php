...
<body class="dashboard">
  ...
  <div class="page">
    <div class="page-header page-header-bordered">
      <ol class="breadcrumb">
        ...
        <li class="active">Edit Tour Package</li>
      </ol>
      <h1 class="page-title">Change Package</h1>
    </div>
    ...
    <div class="container-fluid">
        <form method="POST" action="" enctype="multipart/form-data">
            <div clas="row">
              <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="{{ $tour->package_name }}" name="tour_name">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="{{ $tour->price_per_person }}" name="price_per_person">
                </div>  
              ...
              <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="{{ $tour->package_duration }}" name="duration">
                </div>
                 ...
                 <div  class="form-group">
                  ...
                  <input type="text" id="latitude" value="{{ $tour->latitude }}" class="form-control hide" name="latitude">
                  <input type="text" id="longtitude" value="{{ $tour->longtitude }}" class="form-control hide" name="longtitude">
                </div>
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                ...
                <div class="form-group" style="">
                    ...
                    <textarea class="form-control ckeditor" rows="5" name="include">{{ $tour->price_includes }}</textarea>
                </div>
              ...
              <div class="col-md-6">
                ...
                <div class="form-group" style="">
                    ...
                    <textarea class="form-control ckeditor" rows="5" name="exclude">{{ $tour->price_excludes }}</textarea>
                </div>
              ...
              <div class="form-group" style="padding: 15px;">
                    ...
                    <textarea class="form-control ckeditor" rows="5" name="description">{{ $tour->description }}</textarea>
                </div>


                <div class="form-group" style="padding: 15px;">
                    <label>Itinerary</label>
                    <textarea class="form-control ckeditor" rows="5" name="itinerary">{{ $tour->itinerary }}</textarea>
                </div>
            ...
            <div class="form-group" style="padding-left: 15px;">
                <button type="submit" class="btn btn-primary">Edit Tour Package</button>
            </div>
  ...
  <script src="http://maps.google.com/maps/api/js?sensor=false"></script>
   ...
   <script type="text/javascript">
    ...
    var mymap = L.map('mapid').setView([ {{$tour->latitude}}, {{$tour->longtitude}}], 12);
    L.tileLayer('https://api.tiles.mapbox.com/v4/{id}/{z}/{x}/{y}.png?access_token=pk.eyJ1IjoibWFwYm94IiwiYSI6ImNpandmbXliNDBjZWd2M2x6bDk3c2ZtOTkifQ._QA7i5Mpkd_m30IGElHziw', {
        maxZoom: 18,
        id: 'mapbox.streets'
    }).addTo(mymap);

     L.marker([ {{$tour->latitude}}, {{$tour->longtitude}}]).addTo(mymap);
